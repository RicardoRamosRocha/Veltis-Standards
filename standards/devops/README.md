...
O modulo DevOps define o padrao da Veltis para entrega continua e operacao. Seu objetivo e padronizar ambientes, pipelines, releases, infraestrutura, observabilidade, configuracao, rollback e operacao continua.
...
1. Identifique se a entrega possui impacto em entrega continua e operacao.
...
Um uso adequado deste modulo deve resultar em entregas repetiveis, ambientes previsiveis, falhas observaveis, rollback planejado e operacao documentada.
