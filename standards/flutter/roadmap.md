...
Evoluir o módulo Flutter de forma incremental, preservando consistência com o Veltis Standards e criando materiais aplicáveis a projetos reais.
...
- Definir critérios mínimos para estrutura de projeto, navegação, estado, temas, acessibilidade, integração com APIs, testes e publicação.
...
- Desenvolver templates de tela e checklist de publicação.
...
- Desenvolver integração com APIs, acessibilidade e testes.
...
- Desenvolver maturidade com governança mobile e indicadores.
