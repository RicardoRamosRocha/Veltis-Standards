...
Este módulo tem como objetivo padronizar desenvolvimento mobile e multiplataforma com Flutter. Ele orienta planejamento, execução, revisão e evolução de entregas relacionadas ao tema.

## Escopo

O escopo inclui estrutura de projeto, navegação, estado, temas, acessibilidade, integração com APIs, testes e publicação. O conteúdo deve ser aplicável a diferentes projetos da Veltis e manter independência de decisões específicas de produto.
