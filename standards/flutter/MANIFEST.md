...
Estabelecer um padrão reutilizável para estrutura de projeto, navegação, estado, temas, acessibilidade, integração com APIs, testes e publicação. A missão deste módulo é reduzir ambiguidade, orientar decisões técnicas e apoiar revisões consistentes.
