# Manifesto do Modulo Flutter

## Identidade

- Modulo: $(System.Collections.Hashtable.S)
- Nome: Flutter
- Area: desenvolvimento mobile e multiplataforma com Flutter
- Status: inicial
- Responsabilidade: orientar estrutura de aplicativos, estado, navegacao, temas, acessibilidade, integracao com APIs, testes e publicacao
...
- Definir criterios reutilizaveis para desenvolvimento mobile e multiplataforma com Flutter.
...
Os principais entregaveis esperados sao: convencoes de projeto, guias de componentes, templates de tela, criterios de build e checklist de publicacao.
...
O modulo deve favorecer aplicativos consistentes, performaticos, acessiveis, testaveis e alinhados aos padroes de produto. Conteudos que nao ajudem uma decisao, revisao ou execucao devem ser simplificados, movidos para exemplos ou removidos.
