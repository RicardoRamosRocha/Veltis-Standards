...
Evoluir o módulo Security de forma incremental, preservando consistência com o Veltis Standards e criando materiais aplicáveis a projetos reais.
...
- Definir critérios mínimos para autenticação, autorização, dados sensíveis, segredos, dependências, auditoria, privacidade e resposta a incidentes.
...
- Desenvolver checklists de revisão e gestão de segredos.
...
- Desenvolver modelos de ameaça e resposta a vulnerabilidades.
...
- Desenvolver maturidade com métricas, auditoria e automações.
