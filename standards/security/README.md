...
O modulo Security define o padrao da Veltis para seguranca e privacidade. Seu objetivo e estabelecer controles minimos para autenticacao, autorizacao, dados sensiveis, segredos, auditoria, dependencias e resposta a incidentes.
...
1. Identifique se a entrega possui impacto em seguranca e privacidade.
...
Um uso adequado deste modulo deve resultar em riscos conhecidos, controles documentados, dados protegidos, segredos fora do repositorio e evidencias auditaveis.
