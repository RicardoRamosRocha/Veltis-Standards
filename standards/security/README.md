...
Este módulo tem como objetivo definir controles mínimos de segurança e privacidade para padrões e projetos da Veltis. Ele deve servir como referência profissional para planejamento, execução, revisão e evolução de trabalhos relacionados ao tema.

## Escopo

O escopo inclui autenticação, autorização, dados sensíveis, segredos, dependências, auditoria, privacidade e resposta a incidentes. O conteúdo deve ser aplicável a diferentes projetos da Veltis e manter independência de decisões específicas de produto.
