...
Estabelecer um padrão reutilizável para prompts, modelos, avaliação, privacidade, segurança, monitoramento, riscos e intervenção humana. A missão deste módulo é reduzir ambiguidade, orientar decisões técnicas e apoiar revisões consistentes.
