...
O modulo Checklists define o padrao da Veltis para listas de verificacao de engenharia. Seu objetivo e centralizar checklists reutilizaveis para planejamento, implementacao, revisao, seguranca, testes, release e operacao.
...
1. Identifique se a entrega possui impacto em listas de verificacao de engenharia.
...
Um uso adequado deste modulo deve resultar em listas objetivas, acionaveis, atualizadas, sem redundancia desnecessaria e adequadas ao risco da entrega.
