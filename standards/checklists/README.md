...
Este módulo tem como objetivo centralizar listas de verificação reutilizáveis para melhorar planejamento, revisão e entrega. Ele deve servir como referência profissional para planejamento, execução, revisão e evolução de trabalhos relacionados ao tema.

## Escopo

O escopo inclui checklists de requisitos, arquitetura, PR, segurança, testes, release, operação e qualidade documental. O conteúdo deve ser aplicável a diferentes projetos da Veltis e manter independência de decisões específicas de produto.
