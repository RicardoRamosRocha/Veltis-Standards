...
Este módulo tem como objetivo centralizar listas de verificação reutilizáveis para planejamento, revisão e entrega. Ele orienta planejamento, execução, revisão e evolução de entregas relacionadas ao tema.

## Escopo

O escopo inclui checklists de requisitos, arquitetura, pull request, segurança, testes, release, operação e qualidade documental. O conteúdo deve ser aplicável a diferentes projetos da Veltis e manter independência de decisões específicas de produto.
