# Manifesto do Modulo Checklists

## Identidade

- Modulo: $(System.Collections.Hashtable.S)
- Nome: Checklists
- Area: listas de verificacao de engenharia
- Status: inicial
- Responsabilidade: centralizar checklists reutilizaveis para planejamento, implementacao, revisao, seguranca, testes, release e operacao
...
- Definir criterios reutilizaveis para listas de verificacao de engenharia.
...
Os principais entregaveis esperados sao: checklists por etapa, criterios de pronto, criterios de aceite, matrizes de revisao e exemplos de aplicacao.
...
O modulo deve favorecer listas objetivas, acionaveis, atualizadas, sem redundancia desnecessaria e adequadas ao risco da entrega. Conteudos que nao ajudem uma decisao, revisao ou execucao devem ser simplificados, movidos para exemplos ou removidos.
