...
Este módulo tem como objetivo estabelecer critérios para interfaces consistentes, acessíveis e adequadas ao contexto de uso. Ele deve servir como referência profissional para planejamento, execução, revisão e evolução de trabalhos relacionados ao tema.

## Escopo

O escopo inclui design de telas, componentes, responsividade, acessibilidade, conteúdo de interface e consistência visual. O conteúdo deve ser aplicável a diferentes projetos da Veltis e manter independência de decisões específicas de produto.
