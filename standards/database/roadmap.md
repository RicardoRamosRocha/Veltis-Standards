...
Evoluir o módulo Database de forma incremental, preservando consistência com o Veltis Standards e criando materiais aplicáveis a projetos reais.
...
- Definir critérios mínimos para modelagem, nomenclatura, migrações, integridade, performance, auditoria, backup e governança de dados.
...
- Desenvolver checklists de performance e revisão de schema.
...
- Desenvolver governança de dados, auditoria e retenção.
...
- Desenvolver maturidade operacional com indicadores e automações.
