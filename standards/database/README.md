...
Este módulo tem como objetivo padronizar decisões sobre modelagem, evolução e operação de bancos de dados. Ele orienta planejamento, execução, revisão e evolução de entregas relacionadas ao tema.
