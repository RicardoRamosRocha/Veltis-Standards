...
O modulo Database define o padrao da Veltis para banco de dados e persistencia. Seu objetivo e definir principios para modelagem, migracoes, nomenclatura, integridade, performance, auditoria, backup e operacao de dados.
...
1. Identifique se a entrega possui impacto em banco de dados e persistencia.
...
Um uso adequado deste modulo deve resultar em modelos consistentes, migracoes revisaveis, integridade preservada, dados protegidos e operacao previsivel.
