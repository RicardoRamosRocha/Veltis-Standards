...
Este módulo tem como objetivo padronizar decisões sobre modelagem, evolução e operação de bancos de dados. Ele deve servir como referência profissional para planejamento, execução, revisão e evolução de trabalhos relacionados ao tema.

## Escopo

O escopo inclui modelagem, nomenclatura, migrações, integridade, performance, auditoria, backup e governança de dados. O conteúdo deve ser aplicável a diferentes projetos da Veltis e manter independência de decisões específicas de produto.
