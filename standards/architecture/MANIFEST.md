# Manifesto do Modulo Architecture
...
- Status: inicial
- Responsabilidade: orientar decisoes sobre modularidade, limites de contexto, integracoes, dependencias, evolucao e registro de decisoes arquiteturais
...
- Definir criterios reutilizaveis para arquitetura de software.
...
Os principais entregaveis esperados sao: guias arquiteturais, modelos de ADR, criterios de desenho, exemplos de diagramas e matriz de trade-offs.
...
O modulo deve favorecer decisoes registradas, baixo acoplamento, responsabilidades claras, dependencias justificadas e evolucao sustentavel. Conteudos que nao ajudem uma decisao, revisao ou execucao devem ser simplificados, movidos para exemplos ou removidos.
