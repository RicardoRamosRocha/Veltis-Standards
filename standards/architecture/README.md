...
O modulo Architecture define o padrao da Veltis para arquitetura de software. Seu objetivo e orientar decisoes sobre modularidade, limites de contexto, integracoes, dependencias, evolucao e registro de decisoes arquiteturais.
...
1. Identifique se a entrega possui impacto em arquitetura de software.
...
Um uso adequado deste modulo deve resultar em decisoes registradas, baixo acoplamento, responsabilidades claras, dependencias justificadas e evolucao sustentavel.
