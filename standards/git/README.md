...
O modulo Git define o padrao da Veltis para controle de versao e colaboracao. Seu objetivo e definir fluxo de branches, commits, pull requests, revisoes, tags e releases para reduzir conflitos e melhorar rastreabilidade.
...
1. Identifique se a entrega possui impacto em controle de versao e colaboracao.
...
Um uso adequado deste modulo deve resultar em historico legivel, alteracoes pequenas, revisoes objetivas, mensagens descritivas e releases rastreaveis.
