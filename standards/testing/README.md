...
O modulo Testing define o padrao da Veltis para testes e qualidade. Seu objetivo e definir estrategia de testes, piramide de qualidade, criterios de aceite, automacao, massa de dados, cobertura e confiabilidade dos testes.
...
1. Identifique se a entrega possui impacto em testes e qualidade.
...
Um uso adequado deste modulo deve resultar em testes relevantes, estaveis, rapidos quando possivel, rastreaveis aos requisitos e executados no fluxo de entrega.
