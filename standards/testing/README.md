...
Este módulo tem como objetivo padronizar estratégia de testes e critérios de qualidade para entregas de software. Ele deve servir como referência profissional para planejamento, execução, revisão e evolução de trabalhos relacionados ao tema.

## Escopo

O escopo inclui testes unitários, integração, contrato, regressão, aceitação, automação, dados de teste e qualidade contínua. O conteúdo deve ser aplicável a diferentes projetos da Veltis e manter independência de decisões específicas de produto.
