...
Evoluir o modulo ASP.NET Core de uma estrutura inicial para um conjunto completo de orientacoes, templates, exemplos e criterios verificaveis para desenvolvimento backend com ASP.NET Core.
