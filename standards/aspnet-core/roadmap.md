...
Evoluir o módulo ASP.NET Core de forma incremental, preservando consistência com o Veltis Standards e criando materiais aplicáveis a projetos reais.
...
- Definir critérios mínimos para APIs, configuração, autenticação, autorização, validação, erros, observabilidade e organização de projetos.
...
- Desenvolver templates de endpoints e checklist de segurança.
...
- Desenvolver padrões de observabilidade e versionamento de API.
...
- Desenvolver maturidade operacional para serviços ASP.NET Core.
