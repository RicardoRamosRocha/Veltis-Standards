...
Este módulo tem como objetivo definir padrões para desenvolvimento backend com ASP.NET Core em projetos da Veltis. Ele orienta planejamento, execução, revisão e evolução de entregas relacionadas ao tema.

## Escopo

O escopo inclui APIs, configuração, autenticação, autorização, validação, erros, observabilidade e organização de projetos. O conteúdo deve ser aplicável a diferentes projetos da Veltis e manter independência de decisões específicas de produto.
